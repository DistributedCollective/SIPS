...
The per-part technical SIP documents additionally list, for every replaced module, the
currently-live implementation it replaces (the rollback anchor) and the runtime code hash of
each new artifact.
...
| Calldata                                                             | Frozen into the proposals at creation; diffed against the published tables before voting                                                                                                     |
