...
#### **Core Perimeter Fee contracts** (repo [`Sovryn-perimeter`](https://github.com/DistributedCollective/Sovryn-perimeter), commit `<TBD — deploy commit>`):

| Contract                         | Address                                          |
| -------------------------------- | ------------------------------------------------ |
| ExitFeeController proxy          | `<TBD — filled after deployment + verification>` |
| ExitFeeController implementation | `<TBD — filled after deployment + verification>` |
| ExitFeeVault proxy               | `<TBD — filled after deployment + verification>` |
| ExitFeeVault implementation      | `<TBD — filled after deployment + verification>` |
