...
**Lending / borrowing implementations installed by Part 1** (repo [`Sovryn-smart-contracts`](https://github.com/DistributedCollective/Sovryn-smart-contracts), branch `sovryn-perimeter-fee`, commit `<TBD — deploy commit>`, review in PR [#580](https://github.com/DistributedCollective/Sovryn-smart-contracts/pull/580)):

| Contract              | Address                                          |
| --------------------- | ------------------------------------------------ |
| LoanTokenLogicLM      | `<TBD — filled after deployment + verification>` |
| LoanTokenLogicWrbtcLM | `<TBD — filled after deployment + verification>` |
| LoanClosingsRollover  | `<TBD — filled after deployment + verification>` |
| LoanClosingsWith      | `<TBD — filled after deployment + verification>` |
| LoanMaintenance       | `<TBD — filled after deployment + verification>` |
| ExitFeeModule         | `<TBD — filled after deployment + verification>` |
| ColFeeBorrowerExitOps | `<TBD — filled after deployment + verification>` |

  
#### **Zero implementations installed by Part 1** (repo [`zero-contracts`](https://github.com/DistributedCollective/zero-contracts), branch `sovryn-perimeter-fee`, commit `<TBD — deploy commit>`, review in PR [#10](https://github.com/DistributedCollective/zero-contracts/pull/10)):

| Contract                                       | Address                                          |
| ---------------------------------------------- | ------------------------------------------------ |
| BorrowerOperations implementation (fee-hooked) | `<TBD — filled after deployment + verification>` |
| CollSurplusPool implementation                 | `<TBD — filled after deployment + verification>` |
