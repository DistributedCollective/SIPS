...
* Declaration: proposals for making a public statement on behalf of Sovryn  
...
**Declaration**  
Proposals made to the Declaration track SHOULD be used to make a statement on behalf of Sovryn and can say whatever the author(s) want.

* For example, a Declaration can be used to signal the Sovryn community's support for or disapproval of a certain RSKIP.  
...
* [Declaration](../templates/declaration_template.md)  
