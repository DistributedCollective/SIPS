...
- **Existing loans are unaffected.** Interest rates are locked at loan-open time. Changing the curve only affects positions opened after the SIP executes. Existing borrowers pay the same `interestOwedPerDay` they were already paying.
