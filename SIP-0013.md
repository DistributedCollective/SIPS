...
4. A small index in the second page indicating the tests covered. Also the index page must indicate the total number of pages of the report, **_and the RSK address_** he/she has used to test the feature.
...
5. Each jury will be rewarded with 150 SOV tokens each month. This means a total of 450 SOV tokens per month to pay the jurors. The Leaker will receive 100 SOV per month.
6. In the first day of each month the treasury of Sovryn platform will transfer to the treasury of the contests events (the Multi-Signature contract), a total of 990 SOV tokens and at least 30,000 satoshis to any of the juror members to distribute it among the jury in order to pay gas fees.
