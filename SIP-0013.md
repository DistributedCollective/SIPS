...
The report each user prepares to qualify in the contest, must have the title of the feature tested (e.g.: “**Observations on USDT Integration**”), _**his pseudonym**_ in order for the jury to be able to reach/contact this user and a small index in the first page indicating the tests covered. Also the index page must indicate the total number of pages of the report, **_and the address_** he/she has used to test the feature.
