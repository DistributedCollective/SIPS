...
- ii. If a report is repeated, i.e.: it is reporting exactly the same bugs and recommending the same improvements, will be discarded, giving priority to the first of them.
